...
-- setup_smart_notification_triggers.sql
-- Goal: Ensure all critical system events create intelligent notifications.
...
-- 2. NOTIFY ON NEW JOB APPLICATION (To Family)
...
DECLARE
    ...
    notif_title TEXT := '📋 Cambio en Postulación';
    notif_msg TEXT;
BEGIN
...
CREATE TRIGGER tr_notify_application_status AFTER UPDATE ON job_applications FOR EACH ROW EXECUTE FUNCTION notify_on_application_status_change();
