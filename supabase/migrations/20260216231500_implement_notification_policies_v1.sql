-- implement_notification_policies_v1.sql
-- Automates notifications for applications, reviews, and cancellations
...
DECLARE
    ...
    is_cuidado_plus BOOLEAN;
BEGIN
    SELECT client_id, title, (type = 'Cuidado+') INTO target_client_id, appointment_title, is_cuidado_plus
    FROM appointments 
    ...
    IF target_client_id IS NOT NULL THEN
        ...
        VALUES (
            ...
            jsonb_build_object(
                ...
                'target_path', CASE WHEN is_cuidado_plus THEN '/dashboard/pulso' ELSE '/dashboard' END
            )
        );
    END IF;
    RETURN NEW;
...
-- 4. Notify Caregiver on Appointment Cancellation
