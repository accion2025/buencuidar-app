    ...
    return (
        <div className="min-h-screen flex flex-col font-sans">
            ...
            <main className="max-w-7xl mx-auto px-6 py-16 w-full">
                <div className="grid md:grid-cols-2 gap-12 bg-white rounded-3xl shadow-lg overflow-hidden border border-gray-100">
                    ...
                    <div className="bg-gray-50 p-10 flex flex-col justify-center space-y-8">
                        ...
                        {/* Map Placeholder */}
                        <div className="w-full h-48 bg-gray-200 rounded-xl mt-6 relative overflow-hidden group">
                            <img
                            ...
                            <div className="absolute inset-0 bg-black/10 flex items-center justify-center">
                                <span className="bg-white px-4 py-2 rounded-lg text-xs font-bold shadow-md">Ver en Google Maps</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <form className="space-y-6">
                            <div className="grid md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-[var(--primary-color)] focus:ring-0 transition-colors bg-gray-50 focus:bg-white"
                            ...
                            <button
                                type="button"
                                className="w-full bg-[var(--primary-color)] text-white py-4 rounded-xl font-bold hover:brightness-90 transition-all flex items-center justify-center gap-2"
                            >
                                <Send size={18} />
                                Enviar Mensaje
                            </button>
