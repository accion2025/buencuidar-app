...
const CalendarPage = () => {
    ...
    const getEventColor = (event) => {
        ...
        const [year, month, day] = event.originalDate.split('-').map(Number);
        const eventDate = new Date(year, month - 1, day);

        if (eventDate < today) {
            return 'bg-gray-100 text-gray-500 border-gray-200 opacity-70'; // Pasadas
        }
        return 'bg-blue-100 text-blue-700 border-blue-200 font-medium'; // Programadas
    };
