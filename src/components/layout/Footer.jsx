                ...
                <div className="flex flex-col items-center text-center gap-[10px] mb-8 w-full">
                    ...
                    <ul className="flex flex-col md:flex-row gap-4 md:gap-8 items-center justify-center text-sm font-secondary">
                        ...
                        <li>
                            ...
                            >
                                <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor" className="text-[var(--secondary-color)] group-hover:scale-110 transition-transform">
                        ...
                        <li>
                            ...
                            >
                                <Mail size={24} strokeWidth={1} className="text-[var(--secondary-color)]" />
