                ...
                <div className="flex flex-col items-center text-center gap-[10px] mb-8 w-full">
                    ...
                    <ul className="flex flex-col md:flex-row gap-4 md:gap-8 items-center justify-center text-sm font-secondary">
                        <li className="flex items-center gap-3">
                            <MapPin size={28} className="text-[var(--secondary-color)]" />
                            <span className="text-[#FAFAF7] font-bold text-lg tracking-wide">Managua, Nicaragua</span>
                        </li>
                        <li>
                            <a
                            ...
                            >
                                <svg viewBox="0 0 24 24" width="32" height="32" fill="currentColor" className="text-[var(--secondary-color)] group-hover:scale-110 transition-transform">
                                ...
                                <span className="text-[#FAFAF7] font-bold text-lg tracking-wide">+505 8423 4337</span>
                            </a>
                        </li>
                        <li>
                            <a
                            ...
                            >
                                <Mail size={32} className="text-[var(--secondary-color)]" />
                                <span className="text-[#FAFAF7] font-bold text-lg tracking-wide">soporte@buencuidar.com</span>
                            </a>
                        </li>
                    </ul>
                </div>
