...
const EditAppointmentModal = ({ isOpen, onClose, appointment, onSave, patients = [], isSubscribed }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-start justify-center pt-24 p-6 animate-fade-in overflow-y-auto pb-10">
                    ...
                    <div className="flex-1 p-10 space-y-8">
                        <section className="space-y-4">
                            ...
                            <div className="space-y-4">
                                <div>
                                    <label className="block text-sm font-bold text-gray-400 uppercase tracking-wider mb-2 ml-1">Título</label>
                                    <input
                                        type="text"
                                        required
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <label className="block text-sm font-bold text-gray-400 uppercase tracking-wider mb-2 ml-1">Fecha</label>
                                        <input
                                            type="date"
                                            required
                                            className="w-full px-6 py-4 rounded-[16px] border-2 border-gray-100 font-bold focus:border-blue-500 outline-none transition-all bg-gray-50/30"
                                    ...
                                    <div>
                                        <label className="block text-sm font-bold text-gray-400 uppercase tracking-wider mb-2 ml-1">Horario</label>
                                ...
                                <div>
                                    <label className="block text-sm font-bold text-gray-400 uppercase tracking-wider mb-2 ml-1">Persona a Cuidar</label>
                                    <select
                                ...
                                <div>
                                    <label className="block text-sm font-bold text-gray-400 uppercase tracking-wider mb-2 ml-1">Dirección del Servicio</label>
                                    <input
                                        type="text"
