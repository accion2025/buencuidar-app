        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-md z-[60] flex items-start justify-center pt-5 px-6 pb-6 animate-fade-in overflow-y-auto">
            <div className="bg-white rounded-[16px] shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden relative flex flex-col border border-white/20">
                ...
                <div className="flex-1 overflow-y-auto">
                    {/* Header Redesign for Public Modal */}
                    <div className="relative">
                        ...
                        {(() => {
                            ...
                            const locationString = [details?.municipality, details?.department, countryClean].filter(Boolean).join(', ') || location;
                                ...
                                <div className="pt-24 pb-8 px-6 lg:px-12 text-center mt-2">
                                    ...
                                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-8 w-full">
                                        ...
                                        <div className="bg-slate-50 rounded-2xl p-3 flex flex-col items-center justify-center gap-1.5 border border-transparent hover:border-slate-100 hover:bg-white hover:shadow-lg transition-all">
                                            ...
                                            <div>
                                                <p className="text-[9px] font-black uppercase text-slate-400 tracking-wider mb-0.5">Zona</p>
                                                <p className="text-xs font-brand font-bold text-slate-800 leading-tight max-w-[100px] truncate">
                                                    {locationString}
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="bg-slate-50 rounded-2xl p-3 flex flex-col items-center justify-center gap-1.5 border border-transparent hover:border-slate-100 hover:bg-white hover:shadow-lg transition-all">
                                            ...
                                            <div>
                                                ...
                                                <button onClick={() => onContact(caregiver)} className="text-xs font-brand font-bold text-[var(--secondary-color)] hover:underline">
                                                    Enviar
                                                </button>
                                            </div>
                                        </div>
